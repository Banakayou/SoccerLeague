...
//Menu du Mercato
void Ecran::menuMercato(LigueSoccer* maLigue){
	//1. Permet de lancer une duree de simulation
	//2. Retourner au menuLigue
	int indexMenuMercato = 0;
	cout << "\n" << "Menu de Gestion du Mercato des transferts de la ligue :" << "\n";
	cout << "\n" << "Veuillez faire un choix (tapez 1 a 2) :" << "\n";
	cout << "1. Lancer une simulation sur une duree" << "\n";
	cout << "2. Retourner au menuLigue" << "\n" << "\n";
	cin >> indexMenuMercato;
	while (indexMenuMercato){
		switch (indexMenuMercato){
		case 1:
			//Negociation* negoEnCours = new Negociation();
